sdApp.controller('PlanemodelsList_oldCtrl', function ($scope, $routeParams, $http) {
...
//        $http.get('http://c.raceplanner.de/PG10xp/planemodels.json').
    ...
    $scope.saveDatabase = function () {
        ...
        var transaction = $scope.db.transaction(["planemodels"], "readwrite");
...
// var transaction = db.transaction(["customers"], IDBTransaction.READ_WRITE);
    ...
    $scope.scopeTest = function () {
        alert(JSON.stringify(planemodels));
    }
